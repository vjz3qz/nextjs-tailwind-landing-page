          ...
          >
            ...
            <div className="relative flex flex-col lg:flex-row justify-between items-center">
              ...
              <div className="text-center lg:text-left lg:max-w-xl">
                <h3 className="h3 font-allianceMedium text-white mb-2">
                  Interested in hearing when we launch?
                </h3>
                <p className="text-gray-300 font-allianceRegular text-lg mb-6">
                  Power your prior auth workflow with Trace AI.
                </p>
                ...
                <form className="w-full lg:w-auto" onSubmit={handleSubmit}>
                  <div className="flex flex-col sm:flex-row justify-center max-w-xs mx-auto sm:max-w-md lg:mx-0">
                    ...
                    />
                    <button
                      className="btn font-allianceMedium text-white bg-gray-600 hover:bg-gray-700 shadow"
                      type="submit"
                    >
                      Subscribe
                    </button>
                  ...
                  {/* Success message */}
                  {submitStatus && (
                    <p className="font-allianceLight text-sm text-gray-400 mt-3">
