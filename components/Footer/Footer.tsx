        ...
        <div className="grid sm:grid-cols-12 gap-8 py-8 md:py-12 border-t border-gray-200">
          ...
          <div className="sm:col-span-12 lg:col-span-3">
            <div className="text-sm text-gray-600">
              <a href="#0" className="text-gray-600 hover:text-gray-900 hover:underline transition duration-150 ease-in-out"></a>
            </div>
          </div>
          {/* 1st block */}
          <div className="sm:col-span-12 lg:col-span-3">
...
<div className="sm:col-span-6 md:col-span-3 lg:col-span-2">
  <h6 className="text-gray-800 font-medium mb-2 font-allianceRegular">Contact</h6>
  <ul className="text-sm">
    <li className="mb-2">

      <a href="mailto:vjz3qz@virginia.edu,rahulkm@berkeley.edu,ycz7sm@virginia.edu?subject=Trace%20AI%20Inquiry%3A%20" className="font-allianceLight text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">contact[at]trace.ai</a>
    </li>
    <li className="mb-2">
...
<div className="sm:col-span-6 md:col-span-3 lg:col-span-2">
  ...
  <ul className="text-sm">
    ...
    <li className="mb-2">
      <a href="#0" className="font-allianceLight text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Pricing</a>
    </li>
    <li className="mb-2">
...
<div className="sm:col-span-6 md:col-span-3 lg:col-span-2">
  ...
  <ul className="text-sm">
    <li className="mb-2">
      <a href="#0" className="font-allianceLight text-gray-600 hover:text-gray-900 transition duration-150 ease-in-out">Terms & Conditions</a>
    </li>
    <li className="mb-2">
...
{/* <div className="sm:col-span-6 md:col-span-3 lg:col-span-3">
  <h6 className="text-gray-800 font-medium mb-2 font-allianceRegular">Subscribe</h6>
  <p className="text-sm text-gray-600 mb-4 font-allianceLight">Get the latest news and articles to your inbox every month.</p>
  <form  onSubmit={handleSubmit}>
    <div className="flex flex-wrap mb-4">
      <div className="w-full">
        ...
        <p className="font-allianceLight mt-2 text-green-600 text-sm">Thanks for subscribing!</p>
      </div>
    </div>
  </form>
</div> */}
        ...
        <div className="md:flex md:items-center md:justify-between py-4 md:py-8 border-t border-gray-200">
          ...
          &copy; Made by <a className="text-blue-600 hover:underline">Trace AI</a>.
            All rights reserved.
          </div>
        </div>
      </div>
