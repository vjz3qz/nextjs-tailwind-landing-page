...
const features = [
  {
    ...
    description: 'Transform extensive diagrams into actionable insights with our intelligent data extraction. Grasp component details and flow dynamics for decision-making and maintenance planning.',
    iconPath: '/svgs/layers.svg',
  },
  {
    id: 2,
    title: 'AI-Driven Document and Diagram Integration',
    description: 'Integrate document management with AI in our unified platform. Access, organize, and query essential data effortlessly, boosting decision-making and operational efficiency.',
    iconPath: '/svgs/map.svg',
  },
  {
    id: 3,
    title: 'Tribal Knowledge & Incident Data Capture',
    description: 'Efficiently capture and structure tribal knowledge, along with incident and maintenance data. Our system ensures this crucial knowledge is analyzed effectively and preserved for your team.',
